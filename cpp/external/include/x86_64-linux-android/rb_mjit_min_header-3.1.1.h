...
FILE* funopen64(const void* __cookie,
                ...
                int (*__close_fn)(void*)) __attribute__((__availability__(android,strict,introduced=24)));
...
size_t __fread_chk(void*, size_t, size_t, FILE*, size_t) __attribute__((__availability__(android,strict,introduced=24)));
size_t __fwrite_chk(const void*, size_t, size_t, FILE*, size_t) __attribute__((__availability__(android,strict,introduced=24)));
...
struct stat { dev_t st_dev; ino_t st_ino; unsigned long st_nlink; mode_t st_mode; uid_t st_uid; gid_t st_gid; unsigned int __pad0; dev_t st_rdev; off_t st_size; long st_blksize; long st_blocks; struct timespec st_atim; struct timespec st_mtim; struct timespec st_ctim; long __pad3[3]; };
struct stat64 { dev_t st_dev; ino_t st_ino; unsigned long st_nlink; mode_t st_mode; uid_t st_uid; gid_t st_gid; unsigned int __pad0; dev_t st_rdev; off_t st_size; long st_blksize; long st_blocks; struct timespec st_atim; struct timespec st_mtim; struct timespec st_ctim; long __pad3[3]; };
int chmod(const char* __path, mode_t __mode);
int fchmod(int __fd, mode_t __mode);
int mkdir(const char* __path, mode_t __mode);
int fstat(int __fd, struct stat* __buf);
int fstat64(int __fd, struct stat64* __buf) __attribute__((__availability__(android,strict,introduced=21)));
int fstatat(int __dir_fd, const char* __path, struct stat* __buf, int __flags);
int fstatat64(int __dir_fd, const char* __path, struct stat64* __buf, int __flags) __attribute__((__availability__(android,strict,introduced=21)));
int lstat(const char* __path, struct stat* __buf);
int lstat64(const char* __path, struct stat64* __buf) __attribute__((__availability__(android,strict,introduced=21)));
int stat(const char* __path, struct stat* __buf);
int stat64(const char* __path, struct stat64* __buf) __attribute__((__availability__(android,strict,introduced=21)));
...
int mkfifo(const char* __path, mode_t __mode) __attribute__((__availability__(android,strict,introduced=21)));
...
int mknodat(int __dir_fd, const char* __path, mode_t __mode, dev_t __dev) __attribute__((__availability__(android,strict,introduced=21)));
int utimensat(int __dir_fd, const char* __path, const struct timespec __times[2], int __flags);
int futimens(int __dir_fd, const struct timespec __times[2]) __attribute__((__availability__(android,strict,introduced=19)));
...
unsigned long strtoul_l(const char* __s, char** __end_ptr, int __base, locale_t __l) __attribute__((__availability__(android,strict,introduced=26)));
int atoi(const char* __s) __attribute__((__pure__));
...
long strtol_l(const char* __s, char** __end_ptr, int, locale_t __l) __attribute__((__availability__(android,strict,introduced=26)));
...
static __inline int ffs(int __n) {
  return __builtin_ffs(__n);
}
static __inline int ffsl(long __n) {
  return __builtin_ffsl(__n);
}
static __inline int ffsll(long long __n) {
...
void* mempcpy(void* __dst, const void* __src, size_t __n) __attribute__((__availability__(android,strict,introduced=23)));
...
char* strchrnul(const char* __s, int __ch) __attribute__((__pure__)) __attribute__((__availability__(android,strict,introduced=24)));
...
char* strerror_r(int __errno_value, char* __buf, size_t __n) __asm__("__gnu_strerror_r") __attribute__((__availability__(android,strict,introduced=23)));
...
char* basename(const char* __path) __asm__("__gnu_basename") __attribute__((__availability__(android,strict,introduced=23)));
...
int sigignore(int __signal)
  __attribute__((deprecated("use sigaction() instead"))) __attribute__((__availability__(android,strict,introduced=26)));
int sigpause(int __signal)
  __attribute__((deprecated("use sigsuspend() instead"))) __attribute__((__availability__(android,strict,introduced=26)));
...
char* __getcwd_chk(char*, size_t, size_t) __attribute__((__availability__(android,strict,introduced=24)));
...
ssize_t __pwrite_chk(int, const void*, size_t, off_t, size_t) __attribute__((__availability__(android,strict,introduced=24)));
ssize_t __pwrite_real(int, const void*, size_t, off_t) __asm__("pwrite");
ssize_t __pwrite64_chk(int, const void*, size_t, off64_t, size_t) __attribute__((__availability__(android,strict,introduced=24)));
...
ssize_t __write_chk(int, const void*, size_t, size_t) __attribute__((__availability__(android,strict,introduced=24)));
...
long double lgammal_r(long double __x, int* __sign) __attribute__((__availability__(android,strict,introduced=23)));
long double significandl(long double __x) __attribute__((__availability__(android,strict,introduced=21)));
...
int futimes(int __fd, const struct timeval __times[2]) __attribute__((__availability__(android,strict,introduced=26)));
int lutimes(const char* __path, const struct timeval __times[2]) __attribute__((__availability__(android,strict,introduced=26)));
int futimesat(int __dir_fd, const char* __path, const struct timeval __times[2]) __attribute__((__availability__(android,strict,introduced=26)));
extern char* tzname[];
extern int daylight;
...
size_t strftime_l(char* __buf, size_t __n, const char* __fmt, const struct tm* __tm, locale_t __l) __attribute__((__format__(strftime, 3, 0))) __attribute__((__availability__(android,strict,introduced=21)));
...
static __inline int isalnum(int __ch) {
  return (_ctype_[__ch + 1] & (0x01|0x02|0x04));
}
static __inline int isalpha(int __ch) {
  return (__ch >= 'A' && __ch <= 'Z') || (__ch >= 'a' && __ch <= 'z');
}
static __inline int isblank(int __ch) {
  return __ch == ' ' || __ch == '\t';
}
static __inline int iscntrl(int __ch) {
  return (((unsigned) (__ch)) < ' ') || __ch == 0x7f;
}
static __inline int isdigit(int __ch) {
  return (__ch >= '0' && __ch <= '9');
}
static __inline int isgraph(int __ch) {
  return (__ch >= '!' && __ch <= '~');
}
static __inline int islower(int __ch) {
  return (__ch >= 'a' && __ch <= 'z');
}
static __inline int isprint(int __ch) {
  return (__ch >= ' ' && __ch <= '~');
}
static __inline int ispunct(int __ch) {
  return (_ctype_[__ch + 1] & 0x10);
}
static __inline int isspace(int __ch) {
  return __ch == ' ' || (__ch >= '\t' && __ch <= '\r');
}
static __inline int isupper(int __ch) {
  return (__ch >= 'A' && __ch <= 'Z');
}
static __inline int isxdigit(int __ch) {
  return (__ch >= '0' && __ch <= '9') || (__ch >= 'a' && __ch <= 'f') || (__ch >= 'A' && __ch <= 'F');
}
static __inline int _tolower(int __ch) {
  return __ch | 0x20;
}
static __inline int tolower(int __ch) {
  if (__ch >= 'A' && __ch <= 'Z') return _tolower(__ch);
  return __ch;
}
static __inline int _toupper(int __ch) {
  return __ch ^ 0x20;
}
static __inline int toupper(int __ch) {
  if (__ch >= 'a' && __ch <= 'z') return _toupper(__ch);
  return __ch;
}
static __inline int isascii(int __ch) {
  return ((unsigned) (__ch)) < 0x80;
}
static __inline int toascii(int __ch) {
  return __ch & 0x7f;
}
int isalnum_l(int __ch, locale_t __l) __attribute__((__availability__(android,strict,introduced=21)));
int isalpha_l(int __ch, locale_t __l) __attribute__((__availability__(android,strict,introduced=21)));
int isblank_l(int __ch, locale_t __l) __attribute__((__availability__(android,strict,introduced=21)));
int iscntrl_l(int __ch, locale_t __l) __attribute__((__availability__(android,strict,introduced=21)));
int isdigit_l(int __ch, locale_t __l) __attribute__((__availability__(android,strict,introduced=21)));
int isgraph_l(int __ch, locale_t __l) __attribute__((__availability__(android,strict,introduced=21)));
int islower_l(int __ch, locale_t __l) __attribute__((__availability__(android,strict,introduced=21)));
int isprint_l(int __ch, locale_t __l) __attribute__((__availability__(android,strict,introduced=21)));
int ispunct_l(int __ch, locale_t __l) __attribute__((__availability__(android,strict,introduced=21)));
int isspace_l(int __ch, locale_t __l) __attribute__((__availability__(android,strict,introduced=21)));
int isupper_l(int __ch, locale_t __l) __attribute__((__availability__(android,strict,introduced=21)));
int isxdigit_l(int __ch, locale_t __l) __attribute__((__availability__(android,strict,introduced=21)));
int tolower_l(int __ch, locale_t __l) __attribute__((__availability__(android,strict,introduced=21)));
int toupper_l(int __ch, locale_t __l) __attribute__((__availability__(android,strict,introduced=21)));
__attribute__((__nonnull__ ()))
...
int clone(int (*__fn)(void*), void* __child_stack, int __flags, void* __arg, ...) __attribute__((__availability__(android,strict,introduced=17)));
int unshare(int __flags) __attribute__((__availability__(android,strict,introduced=17)));
int setns(int __fd, int __ns_type) __attribute__((__availability__(android,strict,introduced=21)));
...
int pthread_condattr_getclock(const pthread_condattr_t* __attr, clockid_t* __clock) __attribute__((__availability__(android,strict,introduced=21)));
int pthread_condattr_getpshared(const pthread_condattr_t* __attr, int* __shared);
int pthread_condattr_init(pthread_condattr_t* __attr);
int pthread_condattr_setclock(pthread_condattr_t* __attr, clockid_t __clock) __attribute__((__availability__(android,strict,introduced=21)));
...
int pthread_getname_np(pthread_t __pthread, char* __buf, size_t __n) __attribute__((__availability__(android,strict,introduced=26)));
...
uint32_t htonl(uint32_t __x) __attribute__((__const__)) __attribute__((__availability__(android,strict,introduced=21)));
uint16_t htons(uint16_t __x) __attribute__((__const__)) __attribute__((__availability__(android,strict,introduced=21)));
uint32_t ntohl(uint32_t __x) __attribute__((__const__)) __attribute__((__availability__(android,strict,introduced=21)));
uint16_t ntohs(uint16_t __x) __attribute__((__const__)) __attribute__((__availability__(android,strict,introduced=21)));
...
{
    ec->tag->state = st;
    __builtin_longjmp((void **)((ec->tag->buf)),(1));
}
...
#define __STAT64_BODY dev_t st_dev; ino_t st_ino; unsigned long st_nlink; mode_t st_mode; uid_t st_uid; gid_t st_gid; unsigned int __pad0; dev_t st_rdev; off_t st_size; long st_blksize; long st_blocks; struct timespec st_atim; struct timespec st_mtim; struct timespec st_ctim; long __pad3[3];
#undef __STAT64_BODY
