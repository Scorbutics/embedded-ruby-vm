...
tasks.register("runExample") {
    ...
    doFirst {
        ...
        println("  3. JvmRemoteDebugExample - Arms the rdbg/DAP listener; pauses at binding.break")
        println("  4. JvmRemoteEvalExample  - Arms the line-eval console (TCP, nc-friendly)")
        println()
        ...
        println("  ./gradlew runExample -PexampleClass=JvmRemoteDebugExample")
        println("  ./gradlew runExample -PexampleClass=JvmRemoteEvalExample")
        println()
        println("==============================================")
        println()
    }
